            ...
            <div class="card col-9">
                ...
                <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="desconto" class="form-control" autocomplete="false" id="valorDesconto">
                        </div>
                        <div class="mb-3">
...
<script>
    ...
    async function get(){
        ...
        if(response.ok){
            ...
            if(data.status == "success"){
                ...
                $('#valorDesconto').val(data.data.valorDesconto);
                $('#searchClient').val(data.data.nomeCliente);
                $('#codCliente').val(data.data.codCliente);
                data.data.produtos_fk.forEach(element => {
                    let produto = {
                        codProduto: element.codProduto,
                        nomeProduto: element.produto.nomeProduto,
                        valor: element.produto.valorUnitario,
    ...
    async function update(){
        let response = await fetch(URL_BASE+"/api/pedidos/update/"+clientID,{
            method: 'PUT',
            headers: {
